...
export const techSummary: string[] = [
...
export type CareerDetailTask = { text: string; sub?: string[] };
...
export type CareerDetailItem = {
  ...
  contribution: string;
  overview: string;
  tasks: CareerDetailTask[];
  achievements: string[];
  techStack: string[];
};

export const careerDetails: CareerDetailItem[] = [
  {
    no: 1,
    name: '건물 에너지 사용량 예측 서비스',
    nameEn: 'Energy Prediction Service',
    company: '이에이엔테크놀로지',
    period: '2025.01 ~ 2025.07',
    role: '예측 모델 설계 및 MLOps 구축',
    contribution: '70%',
    overview:
      '15분 단위 에너지 데이터를 기반으로 전력 수요 및 낭비 에너지를 예측하는 ML 서비스 개발',
    tasks: [
    ...
    achievements: [
      '에너지 사용량 예측 모델 R² 0.93 달성',
      '낭비량 예측 모델 MAPE 8.9% 달성',
      '11개 건물 프로덕션 운영 적용',
    ],
  ...
  },
  {
    no: 2,
    name: '건물 재실 예측 서비스',
    nameEn: 'Occupancy Assumption Service',
    company: '이에이엔테크놀로지',
    period: '2024.11 ~ 2025.04',
    role: 'ML 모델 설계 및 API 개발',
    contribution: '70%',
    overview:
      '건물 에너지 데이터를 기반으로 재실 여부 및 재실 밀도를 추론하여 HVAC·조명 자동제어에 활용한 ML 서비스 개발',
    tasks: [
    ...
    achievements: [
      '9개 건물 프로덕션 배포 및 운영',
      'HVAC·조명 자동제어 연계를 통한 비재실 구간 에너지 낭비 감소',
      '실시간 추론 API 안정화 및 False Positive 최소화',
    ],
    techStack: ['HMM', 'KMeans', 'BentoML', 'Grafana'],
  },
  {
    no: 3,
    name: '건물 에너지·IAQ 이상 탐지 서비스',
    nameEn: 'Anomaly Detection Service',
    company: '이에이엔테크놀로지',
    period: '2025.02 ~ 2025.03',
    role: '이상 탐지 알고리즘 및 API 개발',
    contribution: '70%',
    overview:
      '에너지 및 IAQ 센서 데이터를 실시간 분석하여 장비 이상·통신 오류·비정상 패턴을 탐지하는 시스템 개발',
    tasks: [
    ...
    achievements: [
      'Hampel·IQR 동시 탐지 조건 적용으로 오탐지 30~40% 감소',
      '8,896개 이상 센서 실시간 병렬 처리 환경 구축',
      '장비 고장 조기 탐지 체계 운영',
    ],
  ...
  {
    no: 4,
    name: 'DQN 기반 HVAC 자동 제어 시스템',
    nameEn: 'DQN-based HVAC Control',
    company: '이에이엔테크놀로지',
    ...
    tasks: [
      {
        ...
        sub: [
          '상태(State): 실내온도, 설정온도, 외기온도',
          '행동(Action): ±2°C 범위 5단계 제어',
          '보상(Reward): 쾌적도 기반 가우시안 함수 및 설정 변경 패널티 적용',
        ],
      },
    ...
    achievements: [
      '실외기 전력 사용량 14.9% 절감 (57.8 → 49.1 kWh/일)',
      '유사 외기온도 기준 비교군 검증 수행',
      'HVAC 실내기 15대 자동 제어 운영 적용',
    ],
    techStack: ['PyTorch', 'RL(DQN)', 'Airflow'],
  },
  {
    no: 5,
    name: 'LLM 기반 건물 에너지 분석 챗봇',
    nameEn: 'Solution Summary Agent',
    company: '이에이엔테크놀로지',
    period: '2025.07 ~ 2025.10',
    role: 'SQL Agent 아키텍처 및 API 개발',
    contribution: '40%',
    overview:
      '비개발자가 자연어만으로 건물 에너지 데이터를 조회·분석할 수 있는 멀티턴 대화형 에이전트 개발',
    tasks: [
    ...
    achievements: [
      'SQL 없이 복잡한 집계·비교 분석 가능한 환경 구축',
      '비개발자 대상 데이터 접근성 향상',
      '운영 중 오류 사례 개선을 통한 안정성 강화',
    ],
  ...
  },
  {
    no: 6,
    name: '저수지 수위 예측 서비스',
    nameEn: 'Reservoir Level Prediction Service',
    company: '라임솔루션',
    period: '2023.07 ~ 2024.01',
    role: '데이터 분석 및 예측 API 개발',
    contribution: '40%',
    overview:
      '강우량 및 저수지 수위 데이터를 기반으로 12시간 이후 수위를 예측하여 주민 안전 확보 및 수문 조작 의사결정을 지원하는 ML 서비스 개발',
    tasks: [
...
export const navSections = [
  ...
  { id: 'career-detail', label: 'Career Detail' },
