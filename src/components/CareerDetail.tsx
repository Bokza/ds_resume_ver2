...
export function CareerDetail() {
  ...
  const active = careerDetails.find((c) => c.no === activeNo) ?? careerDetails[0];
    ...
    >
      <div className="mx-auto max-w-5xl">
        ...
        <div
          ...
          className="mb-8 flex gap-1 overflow-x-auto border-b border-slate-200 dark:border-slate-800"
        >
        ...
        <div role="tabpanel" key={active.no}>
